...
//         });
// }
// spjprice() spj 0x4d41c76622dcb7208c67d2164cca28d4a21fb323  pnb 0x9fa2c195fd3419a43f2820c1b8de652630c6c2e2
fetch('https://api.geckoterminal.com/api/v2/simple/networks/bsc/token_price/0x9fa2c195fd3419a43f2820c1b8de652630c6c2e2')
    .then(response => response.json())
    .then(data => {
    let price = data['data']['attributes']['token_prices']['0x9fa2c195fd3419a43f2820c1b8de652630c6c2e2']
    // console.log(data['data']['attributes']['token_prices']['0x4d41c76622dcb7208c67d2164cca28d4a21fb323']);
    ourprice.innerHTML = `PNB ${price.substr(0,3) + '...' + price.substr(10,4)}$`
